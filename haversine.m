% FUNCTION MODIFIED FROM https://www.mathworks.com/matlabcentral/fileexchange/27785-distance-calculation-using-haversine-formula?s_tid=gn_loc_drop

function [ft] = haversine(loc1, loc2)
% HAVERSINE     Compute distance between locations using Haversine formula
%   KM = HAVERSINE(LOC1, LOC2) returns the distance FT in ft between
...
%
%   [FT] = HAVERSINE(LOC1, LOC2) returns the computed distance in
%   feet (FT).
%
%   Examples
...
%           5.5858e+05
%       haversine([53.1472 -1.8494], [52.2044 0.1406]) returns 5.5858e+05
%
%   Inputs
